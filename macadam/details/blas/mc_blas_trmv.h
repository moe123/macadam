...
MC_TARGET_FUNC void mc_blas_strmv(const char uplo, const char trans, const char diag, int n, const float * a, int lda, float * x, int incx)
{
...
MC_TARGET_FUNC void mc_blas_dtrmv(const char uplo, const char trans, const char diag, int n, const double * a, int lda, double * x, int incx)
{
...
MC_TARGET_FUNC void mc_blas_ltrmv(const char uplo, const char trans, const char diag, int n, const long double * a, int lda, long double * x, int incx)
{
