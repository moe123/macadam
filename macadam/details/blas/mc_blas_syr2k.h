...
MC_TARGET_FUNC void mc_blas_ssyr2k(const char uplo, const char trans, int n, int k, float alpha, const float * a, int lda, const float * b, int ldb, float beta, float * c, int ldc)
{
...
MC_TARGET_FUNC void mc_blas_dsyr2k(const char uplo, const char trans, int n, int k, double alpha, const double * a, int lda, const double * b, int ldb, double beta, double * c, int ldc)
{
...
MC_TARGET_FUNC void mc_blas_lsyr2k(const char uplo, const char trans, int n, int k, long double alpha, const long double * a, int lda, const long double * b, int ldb, long double beta, long double * c, int ldc)
{
