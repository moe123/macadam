...
static MC_TARGET_INLINE float mc_legendre_pnmf(int n, int m, float x)
{
...
static MC_TARGET_INLINE double mc_legendre_pnm(int n, int m, double x)
{
//!# Associated Legendre polynomials or functions of degree n and order m.
	double p0               = 1.0;
	double p1               = 0.0;
...
static MC_TARGET_INLINE long double mc_legendre_pnml(int n, int m, long double x)
{
//!# Associated Legendre polynomials or functions of degree n and order m.
	long double p0          = 1.0L;
	long double p1          = 0.0L;
