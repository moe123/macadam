...
#pragma mark - mc_cexp2 -

MC_TARGET_PROC mc_complex_float_t mc_cexp2f(const mc_complex_float_t c)
{
...
#	else
	...
	mc_zexp2f(&mc_cmplxrf(z), &mc_cmplxif(z)
		, mc_cmplxrf(c), mc_cmplxif(c)
	);
	return z;
#	endif
...
MC_TARGET_PROC mc_complex_double_t mc_cexp2(const mc_complex_double_t c)
{
#	if MC_TARGET_C99_COMPLEX && ((defined(__linux__) || defined(__gnu_linux__)) && defined(_GNU_SOURCE))
		return cexp2(c);
#	elif MC_TARGET_C99_COMPLEX
...
#	else
	...
	mc_zexp2(&mc_cmplxr(z), &mc_cmplxi(z)
		, mc_cmplxr(c), mc_cmplxi(c)
	);
	return z;
#	endif
...
MC_TARGET_PROC mc_complex_long_double_t mc_cexp2l(const mc_complex_long_double_t c)
{
#	if MC_TARGET_C99_COMPLEX && ((defined(__linux__) || defined(__gnu_linux__)) && defined(_GNU_SOURCE))
		return cexp2l(c);
#	elif MC_TARGET_C99_COMPLEX
...
#	else
	...
	mc_zexp2l(&mc_cmplxrl(z), &mc_cmplxil(z)
		, mc_cmplxrl(c), mc_cmplxil(c)
	);
	return z;
#	endif
