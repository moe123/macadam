...
MC_TARGET_FUNCTION float mc_hermite_henf(unsigned int n, float x)
{
...
MC_TARGET_FUNCTION double mc_hermite_hen(unsigned int n, double x)
{
//!# NTH probabilists' Hermite polynomial.
	double hi      = 0.0;
	double h0      = 0.0;
...
MC_TARGET_FUNCTION long double mc_hermite_henl(unsigned int n, long double x)
{
//!# NTH probabilists' Hermite polynomial.
	long double hi = 0.0L;
	long double h0 = 0.0L;
