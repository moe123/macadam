...
MC_TARGET_FUNC float mc_lchoosef(float x, float y)
{
	if (0 <= y && y <= x) {
...
MC_TARGET_FUNC double mc_lchoose(double x, double y)
{
	if (0 <= y && y <= x) {
...
MC_TARGET_FUNC long double mc_lchoosel(long double x, long double y)
{
	if (0 <= y && y <= x) {
