...
MC_TARGET_FUNC mc_complex_float_t mc_cmulf(mc_complex_float_t a, mc_complex_float_t b)
{
...
MC_TARGET_FUNC mc_complex_double_t mc_cmul(mc_complex_double_t a, mc_complex_double_t b)
{
#	if MC_TARGET_C99_COMPLEX
		return a * b;
#	else
...
MC_TARGET_FUNC mc_complex_long_double_t mc_cmull(mc_complex_long_double_t a, mc_complex_long_double_t b)
{
#	if MC_TARGET_C99_COMPLEX
		return a * b;
#	else
