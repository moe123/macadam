...
MC_TARGET_FUNC float mc_legendre_q0f(float x)
{
...
MC_TARGET_FUNC double mc_legendre_q0(double x)
{
//!# Legendre functions of the second kind, degree 0.
	if (mc_fabs(x) < 1.0) {
		return mc_atanh(x);
...
MC_TARGET_FUNC long double mc_legendre_q0l(long double x)
{
//!# Legendre functions of the second kind, degree 0.
	if (mc_fabsl(x) < 1.0L) {
		return mc_atanhl(x);
...
MC_TARGET_FUNC float mc_legendre_q1f(float x)
{
...
MC_TARGET_FUNC double mc_legendre_q1(double x)
{
//!# Legendre functions of the second kind, degree 1.
	double q1 = 0.0;
	double w, y, f, s, k;
...
MC_TARGET_FUNC long double mc_legendre_q1l(long double x)
{
//!# Legendre functions of the second kind, degree 1.
	long double q1 = 0.0L;
...
MC_TARGET_FUNC float mc_legendre_q2f(float x)
{
...
MC_TARGET_FUNC double mc_legendre_q2(double x)
{
//!# Legendre functions of the second kind, degree 2.
...
MC_TARGET_FUNC long double mc_legendre_q2l(long double x)
{
//!# Legendre functions of the second kind, degree 2.
...
MC_TARGET_FUNC float mc_legendre_q3f(float x)
{
...
MC_TARGET_FUNC double mc_legendre_q3(double x)
{
//!# Legendre functions of the second kind, degree 3.
...
MC_TARGET_FUNC long double mc_legendre_q3l(long double x)
{
//!# Legendre functions of the second kind, degree 3.
...
MC_TARGET_FUNC float mc_legendre_q4f(float x)
{
...
MC_TARGET_FUNC double mc_legendre_q4(double x)
{
//!# Legendre functions of the second kind, degree 4.
...
MC_TARGET_FUNC long double mc_legendre_q4l(long double x)
{
//!# Legendre functions of the second kind, degree 4.
...
MC_TARGET_FUNC float mc_legendre_q5f(float x)
{
...
MC_TARGET_FUNC double mc_legendre_q5(double x)
{
//!# Legendre functions of the second kind, degree 5.
...
MC_TARGET_FUNC long double mc_legendre_q5l(long double x)
{
//!# Legendre functions of the second kind, degree 5.
