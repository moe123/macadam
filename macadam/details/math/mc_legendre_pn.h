...
MC_TARGET_FUNC float mc_legendre_p0f(float x)
{
	x = 1.0f;
	return x;
}

MC_TARGET_FUNC double mc_legendre_p0(double x)
{
	x = 1.0;
	return x;
}

MC_TARGET_FUNC long double mc_legendre_p0l(long double x)
{
	x = 1.0L;
	return x;
}
...
MC_TARGET_FUNC float mc_legendre_p1f(float x)
{
	return x;
}

MC_TARGET_FUNC double mc_legendre_p1(double x)
{
	return x;
}

MC_TARGET_FUNC long double mc_legendre_p1l(long double x)
{
	return x;
}
...
MC_TARGET_FUNC float mc_legendre_p2f(float x)
{
	return 1.5f * mc_raise2f(x) - 0.5f;
}

MC_TARGET_FUNC double mc_legendre_p2(double x)
{
	return 1.5 * mc_raise2(x) - 0.5;
}

MC_TARGET_FUNC long double mc_legendre_p2l(long double x)
{
...
MC_TARGET_FUNC float mc_legendre_p3f(float x)
{
	return 0.5f * ((5.0f * mc_raise3f(x)) - (3.0f * x));
}

MC_TARGET_FUNC double mc_legendre_p3(double x)
{
	return 0.5 * ((5.0 * mc_raise3(x)) - (3.0 * x));
}

MC_TARGET_FUNC long double mc_legendre_p3l(long double x)
{
...
MC_TARGET_FUNC float mc_legendre_p4f(float x)
{
	return 0.125f * (((35.0f * mc_raise4f(x)) - (30.0f * mc_raise2f(x))) + 3.0f);
}

MC_TARGET_FUNC double mc_legendre_p4(double x)
{
	return 0.125 * (((35.0 * mc_raise4(x)) - (30.0 * mc_raise2(x))) + 3.0);
}

MC_TARGET_FUNC long double mc_legendre_p4l(long double x)
{
...
MC_TARGET_FUNC float mc_legendre_p5f(float x)
{
	return 0.125f * (((63.0f * mc_raise5f(x)) - (70.0f * mc_raise3f(x))) + (15.0f * x));
}

MC_TARGET_FUNC double mc_legendre_p5(double x)
{
	return 0.125 * (((63.0 * mc_raise5(x)) - (70.0 * mc_raise3(x))) + (15.0 * x));
}

MC_TARGET_FUNC long double mc_legendre_p5l(long double x)
{
