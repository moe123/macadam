...
MC_TARGET_FUNCTION float mc_hermite_h0f(float x)
{
...
MC_TARGET_FUNCTION double mc_hermite_h0(double x)
{
//!# Physicists' Hermite polynomial, degree 0.
	x = 1.0;
	return x;
...
MC_TARGET_FUNCTION long  double mc_hermite_h0l(long double x)
{
//!# Physicists' Hermite polynomial, degree 0.
	x = 1.0L;
	return x;
...
MC_TARGET_FUNCTION float mc_hermite_h1f(float x)
{
//!# Physicists' Hermite polynomial, degree 1.
	return 2.0f * x;
}

MC_TARGET_FUNCTION double mc_hermite_h1(double x)
{
//!# Physicists' Hermite polynomial, degree 1.
	return 2.0 * x;
}

MC_TARGET_FUNCTION long  double mc_hermite_h1l(long double x)
{
//!# Physicists' Hermite polynomial, degree 1.
	return 2.0L * x;
}
...
MC_TARGET_FUNCTION float mc_hermite_h2f(float x)
{
//!# Physicists' Hermite polynomial, degree 2.
	return (4.0f * mc_raise2f(x)) - 2.0f;
}

MC_TARGET_FUNCTION double mc_hermite_h2(double x)
{
//!# Physicists' Hermite polynomial, degree 2.
	return (4.0 * mc_raise2(x)) - 2.0;
}

MC_TARGET_FUNCTION long double mc_hermite_h2l(long double x)
{
//!# Physicists' Hermite polynomial, degree 2.
...
MC_TARGET_FUNCTION float mc_hermite_h3f(float x)
{
//!# Physicists' Hermite polynomial, degree 3.
	return (8.0f * mc_raise3f(x)) - (12.0f * x);
}

MC_TARGET_FUNCTION double mc_hermite_h3(double x)
{
//!# Physicists' Hermite polynomial, degree 3.
	return (8.0 * mc_raise3(x)) - (12.0 * x);
}

MC_TARGET_FUNCTION long double mc_hermite_h3l(long double x)
{
//!# Physicists' Hermite polynomial, degree 3.
...
MC_TARGET_FUNCTION float mc_hermite_h4f(float x)
{
//!# Physicists' Hermite polynomial, degree 4.
	return (16.0f * mc_raise4f(x)) - (48.0f * mc_raise2f(x)) + 12.0f;
}

MC_TARGET_FUNCTION double mc_hermite_h4(double x)
{
//!# Physicists' Hermite polynomial, degree 4.
	return (16.0 * mc_raise4(x)) - (48.0 * mc_raise2(x)) + 12.0;
}

MC_TARGET_FUNCTION long double mc_hermite_h4l(long double x)
{
//!# Physicists' Hermite polynomial, degree 4.
...
MC_TARGET_FUNCTION float mc_hermite_h5f(float x)
{
//!# Physicists' Hermite polynomial, degree 5.
	return (120.0f * x) - (160.0f * mc_raise3f(x)) + (32.0f * mc_raise5f(x));
}

MC_TARGET_FUNCTION double mc_hermite_h5(double x)
{
//!# Physicists' Hermite polynomial, degree 5.
	return (120.0 * x) - (160.0 * mc_raise3(x)) + (32.0 * mc_raise5(x));
}

MC_TARGET_FUNCTION long double mc_hermite_h5l(long double x)
{
//!# Physicists' Hermite polynomial, degree 5.
...
MC_TARGET_FUNCTION float mc_hermite_hnf(unsigned int n, float x)
{
...
MC_TARGET_FUNCTION double mc_hermite_hn(unsigned int n, double x)
{
//!# NTH physicists' Hermite polynomial.
	double hi      = 0.0;
	double h0      = 0.0;
...
MC_TARGET_FUNCTION long double mc_hermite_hnl(unsigned int n, long double x)
{
//!# NTH physicists' Hermite polynomial.
	long double hi = 0.0L;
	long double h0 = 0.0L;
