...
MC_TARGET_FUNCTION float mc_gammasignf(float x)
{
...
MC_TARGET_FUNCTION double mc_gammasign(double x)
{
...
MC_TARGET_FUNCTION long double mc_gammasignl(long double x)
{
