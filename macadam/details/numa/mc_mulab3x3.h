...
MC_TARGET_FUNC void mc_mulab3x3fd(double * restrict c, const float a[9], const double b[9])
{
//!# c=a*b
...
MC_TARGET_FUNC void mc_mulab3x3df(double * restrict c, const double a[9], const float b[9])
{
//!# c=a*b
...
MC_TARGET_FUNC void mc_mulab3x3(double * restrict c, const double a[9], const double b[9])
{
//!# c=a*b
	c[0] = (a[0] * b[0]) + (a[1] * b[3]) + (a[2] * b[6]);
	c[1] = (a[0] * b[1]) + (a[1] * b[4]) + (a[2] * b[7]);
...
MC_TARGET_FUNC void mc_mulab3x3l(long double * restrict c, const long double a[9], const long double b[9])
{
//!# c=a*b
	c[0] = (a[0] * b[0]) + (a[1] * b[3]) + (a[2] * b[6]);
	c[1] = (a[0] * b[1]) + (a[1] * b[4]) + (a[2] * b[7]);
