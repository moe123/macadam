...
MC_TARGET_FUNC float mc_infnormnxnf(int n, const float * a, int f)
{
...
MC_TARGET_FUNC double mc_infnormnxnff(int n, const float * a, int f)
{
//!# Requires a[n x n]. Returning the infinity norm of a.
//!# f=0: computing the maximum of the absolute row sums.
//!# f=1: computing the minimum of the absolute row sums.
...
MC_TARGET_FUNC double mc_infnormnxn(int n, const double * a, int f)
{
//!# Requires a[n x n]. Returning the infinity norm of a.
//!# f=0: computing the maximum of the absolute row sums.
//!# f=1: computing the minimum of the absolute row sums.
...
MC_TARGET_FUNC long double mc_infnormnxnl(int n, const long double * a, int f)
{
//!# Requires a[n x n]. Returning the infinity norm of a.
//!# f=0: computing the maximum of the absolute row sums.
//!# f=1: computing the minimum of the absolute row sums.
