...
MC_TARGET_FUNC int mc_orthonxnf(const int n, const float * a, float tol, float * q, float * restrict r)
{
...
MC_TARGET_FUNC int mc_orthonxnff(const int n, const float * a, float tol, double * q, double * restrict r)
{
...
MC_TARGET_FUNC int mc_orthonxn(const int n, const double * a, double tol, double * q, double * restrict r)
{
//!# A and Q may be the same. Forming a ortho-normalized basis Q
//!# of a square matrix using Modified Gram-Schmidt method.
...
MC_TARGET_FUNC int mc_orthonxnl(const int n, const long double * a, long double tol, long double * q, long double * restrict r)
{
//!# A and Q may be the same. Forming a ortho-normalized basis Q
//!# of a square matrix using Modified Gram-Schmidt method.
