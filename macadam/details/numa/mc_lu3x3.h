...
//!# Computing e1a=e1*a
		...
		float e1a21 = (e121 * a[0]) + (e122 * a[3]) + (e123 * a[6]);
		float e1a22 = (e121 * a[1]) + (e122 * a[4]) + (e123 * a[7]);
		float e1a23 = (e121 * a[2]) + (e122 * a[5]) + (e123 * a[8]);

		float e1a31 = (e131 * a[0]) + (e132 * a[3]) + (e133 * a[6]);
		float e1a32 = (e131 * a[1]) + (e132 * a[4]) + (e133 * a[7]);
...
//!# Computing e1a=e1*a
		...
		double e1a21 = (e121 * mc_cast(double, a[0])) + (e122 * mc_cast(double, a[3])) + (e123 * mc_cast(double, a[6]));
		double e1a22 = (e121 * mc_cast(double, a[1])) + (e122 * mc_cast(double, a[4])) + (e123 * mc_cast(double, a[7]));
		double e1a23 = (e121 * mc_cast(double, a[2])) + (e122 * mc_cast(double, a[5])) + (e123 * mc_cast(double, a[8]));

		double e1a31 = (e131 * mc_cast(double, a[0])) + (e132 * mc_cast(double, a[3])) + (e133 * mc_cast(double, a[6]));
		double e1a32 = (e131 * mc_cast(double, a[1])) + (e132 * mc_cast(double, a[4])) + (e133 * mc_cast(double, a[7]));
...
//!# Computing e1a=e1*a
		...
		double e1a21 = (e121 * a[0]) + (e122 * a[3]) + (e123 * a[6]);
		double e1a22 = (e121 * a[1]) + (e122 * a[4]) + (e123 * a[7]);
		double e1a23 = (e121 * a[2]) + (e122 * a[5]) + (e123 * a[8]);

		double e1a31 = (e131 * a[0]) + (e132 * a[3]) + (e133 * a[6]);
		double e1a32 = (e131 * a[1]) + (e132 * a[4]) + (e133 * a[7]);
...
//!# Computing e1a=e1*a
		...
		long double e1a21 = (e121 * a[0]) + (e122 * a[3]) + (e123 * a[6]);
		long double e1a22 = (e121 * a[1]) + (e122 * a[4]) + (e123 * a[7]);
		long double e1a23 = (e121 * a[2]) + (e122 * a[5]) + (e123 * a[8]);

		long double e1a31 = (e131 * a[0]) + (e132 * a[3]) + (e133 * a[6]);
		long double e1a32 = (e131 * a[1]) + (e132 * a[4]) + (e133 * a[7]);
