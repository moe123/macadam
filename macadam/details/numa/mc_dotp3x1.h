...
MC_TARGET_FUNC float mc_dotp3x1f(int n, int j, int k, const float * a, const float * b, int f)
{
...
MC_TARGET_FUNC double mc_dotp3x1ff(int n, int j, int k, const float * a, const float * b, int f)
{
...
MC_TARGET_FUNC double mc_dotp3x1(int n, int j, int k, const double * a, const double * b, int f)
{
	double s = 0.0, e = 0.0, x, y;
...
MC_TARGET_FUNC long double mc_dotp3x1l(int n, int j, int k, const long double * a, const long double * b, int f)
{
