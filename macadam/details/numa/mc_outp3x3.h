...
#pragma mark - mc_outp3x3 -

MC_TARGET_FUNC void mc_outp3x3f(float a[9], const float x[3], const float y[3])
{
...
MC_TARGET_FUNC void mc_outp3x3ff(double a[9], const float x[3], const float y[3])
{
//!# Requires a[3 x 3], x[3 x 1] and y[3 x 1].
//!# c=x*y' i.e outer product of two vectors.
...
MC_TARGET_FUNC void mc_outp3x3fd(double a[9], const float x[3], const double y[3])
{
//!# Requires a[3 x 3], x[3 x 1] and y[3 x 1].
//!# c=x*y' i.e outer product of two vectors.
...
MC_TARGET_FUNC void mc_outp3x3df(double a[9], const double x[3], const float y[3])
{
//!# Requires a[3 x 3], x[3 x 1] and y[3 x 1].
//!# c=x*y' i.e outer product of two vectors.
...
MC_TARGET_FUNC void mc_outp3x3(double a[9], const double x[3], const double y[3])
{
//!# Requires a[3 x 3], x[3 x 1] and y[3 x 1].
//!# c=x*y' i.e outer product of two vectors.
	a[0] = x[0] * y[0];
...
MC_TARGET_FUNC void mc_outp3x3l(long double a[9], const long double x[3], const long double y[3])
{
//!# Requires a[3 x 3], x[3 x 1] and y[3 x 1].
//!# c=x*y' i.e outer product of two vectors.
	a[0] = x[0] * y[0];
