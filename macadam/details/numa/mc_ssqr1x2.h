...
#pragma mark - mc_ssqr1x2 -

MC_TARGET_FUNC void mc_ssqr1x2f(const float x[2], float * sumsq, float * scale)
{
	float t;
...
MC_TARGET_FUNC void mc_ssqr1x2ff(const float x[2], double * sumsq, double * scale)
{
	double t;
...
MC_TARGET_FUNC void mc_ssqr1x2(const double x[2], double * sumsq, double * scale)
{
	double t;
...
MC_TARGET_FUNC void mc_ssqr1x2l(const long double x[2], long double * sumsq, long double * scale)
{
	long double t;
