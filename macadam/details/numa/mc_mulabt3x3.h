...
MC_TARGET_FUNC void mc_mulabt3x3(double * c, const double a[9], const double b[9])
{
//!# c=a*b'
		c[0] = (a[0] * b[0]) + (a[1] * b[1]) + (a[2] * b[2]);
		c[1] = (a[0] * b[3]) + (a[1] * b[4]) + (a[2] * b[5]);
...
MC_TARGET_FUNC void mc_mulabt3x3l(long double * c, const long double a[9], const long double b[9])
{
//!# c=a*b'
		c[0] = (a[0] * b[0]) + (a[1] * b[1]) + (a[2] * b[2]);
		c[1] = (a[0] * b[3]) + (a[1] * b[4]) + (a[2] * b[5]);
