...
MC_TARGET_FUNC float mc_infnorm1xnf(int n, const float * x, int f)
{
...
MC_TARGET_FUNC double mc_infnorm1xnff(int n, const float * x, int f)
{
//!# Requires x[1 x n]. Returning the infinity norm of x.
//!# f=0: computing the maximum of the absolute values.
//!# f=1: computing the minimum of the absolute values.
...
MC_TARGET_FUNC double mc_infnorm1xn(int n, const double * x, int f)
{
//!# Requires x[1 x n]. Returning the infinity norm of x.
...
MC_TARGET_FUNC long double mc_infnorm1xnl(int n, const long double * x, int f)
{
//!# Requires x[1 x n]. Returning the infinity norm of x.
//!# f=0: computing the maximum of the absolute row sums.
//!# f=1: computing the minimum of the absolute row sums.
