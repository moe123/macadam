...
MC_TARGET_PROC void mc_zeye2x2f(
	...
	*v0_r = 1.0f; *v0_i = 0.0f; *v1_r = 0.0f; *v1_i = 0.0f;
	*v2_r = 0.0f; *v2_i = 0.0f; *v3_r = 1.0f; *v3_i = 0.0f;
}
...
MC_TARGET_PROC void mc_zeye2x2(
	...
	*v0_r = 1.0; *v0_i = 0.0; *v1_r = 0.0; *v1_i = 0.0;
	*v2_r = 0.0; *v2_i = 0.0; *v3_r = 1.0; *v3_i = 0.0;
}
...
MC_TARGET_PROC void mc_zeye2x2l(
	...
	*v0_r = 1.0L; *v0_i = 0.0L; *v1_r = 0.0L; *v1_i = 0.0L;
	*v2_r = 0.0L; *v2_i = 0.0L; *v3_r = 1.0L; *v3_i = 0.0L;
}
