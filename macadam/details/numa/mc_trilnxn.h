...
MC_TARGET_FUNC void mc_trilnxnf(const int n, float * restrict c, const float * a, int f)
{
...
MC_TARGET_FUNC void mc_trilnxn(const int n, double * restrict c, const double * a, int f)
{
//!# f=0: default behavior.
//!# f=1: excluding diagonal.
//!# f=2: excluding diagonal and setting it to ones.
...
MC_TARGET_FUNC void mc_trilnxnl(const int n, long double * restrict c, const long double * a, int f)
{
//!# f=0: default behavior.
//!# f=1: excluding diagonal.
//!# f=2: excluding diagonal and setting it to ones.
