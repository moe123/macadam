...
MC_TARGET_FUNC int mc_mgsmxnf(const int m, const int n, const float * a, float * q, float * restrict r)
{
...
MC_TARGET_FUNC int mc_mgsmxnff(const int m, const int n, const float * a, double * q, double * restrict r)
{
//!# Requires a[m x n], q[m x n] and r[n x n] where 1 < n <= m.
...
MC_TARGET_FUNC int mc_mgsmxn(const int m, const int n, const double * a, double * q, double * restrict r)
{
//!# Requires a[m x n], q[m x n] and r[n x n] where 1 < n <= m.
//!# A and Q may be the same. Performing a QR decomposition
//!# using Modified Gram-Schmidt method.
...
MC_TARGET_FUNC int mc_mgsmxnl(const int m, const int n, const long double * a, long double * q, long double * restrict r)
{
//!# Requires a[m x n], q[m x n] and r[n x n] where 1 < n <= m.
//!# A and Q may be the same. Performing a QR decomposition
//!# using Modified Gram-Schmidt method.
