...
MC_TARGET_FUNC void mc_mstddv1xnf(int n, const float * x, int b, float * mean, float * stddev, float * var)
{
	float sumsq, scale;
...
MC_TARGET_FUNC void mc_mstddv1xnff(int n, const float * x, int b, double * mean, double * stddev, double * var)
{
	double sumsq, scale;
...
MC_TARGET_FUNC void mc_mstddv1xn(int n, const double * x, int b, double * mean, double * stddev, double * var)
{
	double sumsq, scale;
...
MC_TARGET_FUNC void mc_mstddv1xnl(int n, const long double * x, int b, long double * mean, long double * stddev, long double * var)
{
