...
MC_TARGET_FUNC int mc_cumprod1xnf(const int n, float * u, const float * x, int f)
{
...
MC_TARGET_FUNC int mc_cumprod1xnff(const int n, double * u, const float * x, int f)
{
...
MC_TARGET_FUNC int mc_cumprod1xn(const int n, double * u, const double * x, int f)
{
//!# Requires u[1 x n] and x[1 x n] where 1 < n. U and X may be
//!# the same. Returning the cumulative product of the elements.
//!# f=0: forward cumulative product.
...
MC_TARGET_FUNC int mc_cumprod1xnl(const int n, long double * u, const long double * x, int f)
{
//!# Requires u[1 x n] and x[1 x n] where 1 < n. U and X may be
//!# the same. Returning the cumulative product of the elements.
//!# f=0: forward cumulative product.
