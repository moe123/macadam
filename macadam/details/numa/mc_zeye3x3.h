...
MC_TARGET_PROC void mc_zeye3x3f(
	...
	*v0_r = 1.0f; *v0_i = 0.0f; *v1_r = 0.0f; *v1_i = 0.0f; *v2_r = 0.0f; *v2_i = 0.0f;
	*v3_r = 0.0f; *v3_i = 0.0f; *v4_r = 1.0f; *v4_i = 0.0f; *v5_r = 0.0f; *v5_i = 0.0f;
	*v6_r = 0.0f; *v6_i = 0.0f; *v7_r = 0.0f; *v7_i = 0.0f; *v8_r = 1.0f; *v8_i = 0.0f;
}
...
MC_TARGET_PROC void mc_zeye3x3(
	...
	*v0_r = 1.0; *v0_i = 0.0; *v1_r = 0.0; *v1_i = 0.0; *v2_r = 0.0; *v2_i = 0.0;
	*v3_r = 0.0; *v3_i = 0.0; *v4_r = 1.0; *v4_i = 0.0; *v5_r = 0.0; *v5_i = 0.0;
	*v6_r = 0.0; *v6_i = 0.0; *v7_r = 0.0; *v7_i = 0.0; *v8_r = 1.0; *v8_i = 0.0;
}
...
MC_TARGET_PROC void mc_zeye3x3l(
	...
	*v0_r = 1.0L; *v0_i = 0.0L; *v1_r = 0.0L; *v1_i = 0.0L; *v2_r = 0.0L; *v2_i = 0.0L;
	*v3_r = 0.0L; *v3_i = 0.0L; *v4_r = 1.0L; *v4_i = 0.0L; *v5_r = 0.0L; *v5_i = 0.0L;
	*v6_r = 0.0L; *v6_i = 0.0L; *v7_r = 0.0L; *v7_i = 0.0L; *v8_r = 1.0L; *v8_i = 0.0L;
}
