...
#	if MC_TARGET_CPP11
template <>        MC_TARGET_INLINE unsigned long long mclimits_digits<unsigned long long> (const unsigned long long& x) { mc_unused(x); return CHAR_BIT * sizeof(unsigned long long); }
#	endif
